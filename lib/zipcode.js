...
(function(){
  var Zipcode = function(){
    var find = function(addr, callback){
      ...
      if (lenNum != lenAddrTokens && addrTokens[lenNum][_UNIT] != '號'){
        lenNum++
      }
        ...
        function(next) {
          ...
          getRsPair(address.flat(addrTokens, i), function(err, rows){
            ...
            if (i == lenNum && lenAddrTokens >= 4 &&
              ...
              console.log(lenAddrTokens)
              console.log(addrTokens[3][_UNIT] == undefined && addrTokens[3][_NO] > 0)
              console.log(addrTokens[3][_UNIT] == '號');
              ...
              getRsPair(address.flat(addrTokens, 3), function(err, rows){
                rsPair = rows
                if (rsPair){
                  console.log(address.flat(addrTokens, 3))
                  console.log(rsPair)
